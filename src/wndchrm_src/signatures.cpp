...
int signatures::SaveToFile2 (std::vector<double>* tmpOutputData, std::vector<double> uniqueClasses, bool ROIFlag, std::string MaskFilename, char * ImageTransformationName, char * FeatureAlgorithmName) {
    ...
    const char* Titles[] = {
        ...
        "filled_area_pixels",
        "max_inclosing_circle_diameter",
        "diameter_min_enclosing_circle",
        "diameter_circumscribing_circle",
        "diameter_inscribing_circle",
        "diameter_equal_perimeter",
        "rotated_bounding_box_height",
        "rotated_bounding_box_width",
        "geodetic_length",
        "thickness",
        "erosion_pixels",
        "erosion_complement_pixels",
        "fractal_dimension_box_counting",
        "fractal_dimension_perimeter",
        "feret_diameter_min",
        "feret_diameter_max",
        "feret_diameter_mean",
        "feret_diameter_median",
        "feret_diameter_std",
        "feret_diameter_mode",
        "martin_length_min",
        "martin_length_max",
        "martin_length_mean",
        "martin_length_median",
        "martin_length_std",
        "martin_length_mode",
        "nassenstein_diameter_min",
        "nassenstein_diameter_max",
        "nassenstein_diameter_mean",
        "nassenstein_diameter_median",
        "nassenstein_diameter_std",
        "nassenstein_diameter_mode",
        "maxchords_min",
        "maxchords_max",
        "maxchords_mean",
        "maxchords_median",
