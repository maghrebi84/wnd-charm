...
int ImageMatrix::LoadTIFF(char *filename) {
        ...
        if( (tif = TIFFOpen(filename, "r")) ) {
            ...
            cout<<" Image could not be read by libtiff"<<endl;
            return(0);
        }
...
output[20]=y_centroid;
output[21]=x_centroid;
}


//find more about the algorithms computed here at:
//https://pyradiomics.readthedocs.io/en/latest/features.html#module-radiomics.firstorder
